...
const detailFieldsToFetch = 'title,description,price,rating,brand,category,images,reviews';

export const getProduct = (productId: string) => fetch(`${baseEndPoint}/${productId}?select=${detailFieldsToFetch}`);
